...
## Цели проекта
  ...
  - Автоматический парсинг требований вакансий
  - Автоматически оценивать соответствие вакансий своему резюме
  - представление вакансий в таблице с метрикой соответствия резюме (метрика в диапазоне 0-100)
  - фильтр по метрике соответствию
  - фильтр компаний (фильтруются неинтересные компании)
  - Массовый отклик на вакансии с фильтром по соответствию и имени компании 
